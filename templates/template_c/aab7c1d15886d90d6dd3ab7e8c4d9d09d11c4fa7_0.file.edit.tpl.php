...
function content_64589b9de94b62_33735164 (Smarty_Internal_Template $_smarty_tpl) {
...
/sources/KhoSanXuat-Kho-Vmnt-Xuat-Kho.php?act=<?php if ($_REQUEST['act'] == 'add') {?>addsm<?php } else { ?>editsm<?php }?>&cid=<?php echo $_REQUEST['cid'];?>
...
>
                                <div id="siteIDload">
                                    <select name="madhin" id="madhin" class="abcd chonphonbanSanXuat" onchange="getSLVaoCotGhiChu(this.value)">
                                         ...
                                         <?php echo insert_optionChoDonHangCatalog(array('madhin' => $_smarty_tpl->tpl_vars['edit']->value['madhin'], 'cid' => $_smarty_tpl->tpl_vars['phongbanchuyen']->value),$_smarty_tpl);?>
                                    </select> 
                                </div>
                             </td>
