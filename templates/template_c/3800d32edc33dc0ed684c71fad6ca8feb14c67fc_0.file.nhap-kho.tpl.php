<?php
/* Smarty version 4.1.1, created on 2023-05-09 14:01:08
  from 'D:\wamp64\www\duan_demo\templates\tpl\KhoSanXuat-Kho-Kv-Thong-Ke\nhap-kho.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6459efb41233c6_69657376',
  'has_nocache_code' => true,
  'file_dependency' => 
  array (
    '3800d32edc33dc0ed684c71fad6ca8feb14c67fc' => 
    array (
      0 => 'D:\\wamp64\\www\\duan_demo\\templates\\tpl\\KhoSanXuat-Kho-Kv-Thong-Ke\\nhap-kho.tpl',
      1 => 1683615229,
      2 => 'file',
    ),
  ),
  ...
  array (
    ...
    'file:./allsearch/phongsxs.tpl' => 1,
    'file:./allsearch/phongchuyens.tpl' => 1,
    ...
    'file:./allsearch/tlq10s.tpl' => 1,
    'file:./allsearch/tlq10gcs.tpl' => 1,
    'file:./allsearch/madhsxs.tpl' => 1,
    'file:./allsearch/ghichus.tpl' => 1,
  ),
),false)) {
function content_6459efb41233c6_69657376 (Smarty_Internal_Template $_smarty_tpl) {
...
/sources/KhoSanXuat-Kho-kv-Thong-Ke.php?act=<?php echo $_REQUEST['act'];?>
...
?>
            ...
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['xuatkho']->value == 1) {?>
                <input type="hidden" id="getUrlPrintKhoNguonVao" value="act=xuatkho&table=khosanxuat_khokv&cid=<?php echo $_smarty_tpl->tpl_vars['phongbanchuyen']->value;?>
"  />
                <input type="hidden" id="getUrlExportExcel" value="act=KhoSanXuatNhapXuat&type=xuatkho&table=khosanxuat_khokv&cid=<?php echo $_smarty_tpl->tpl_vars['phongbanchuyen']->value;?>
"  />
            <?php } else { ?>
                <input type="hidden" id="getUrlPrintKhoNguonVao" value="act=nhapkho&table=khosanxuat_khokv&cid=<?php echo $_smarty_tpl->tpl_vars['phongbanchuyen']->value;?>
"  />
                <input type="hidden" id="getUrlExportExcel" value="act=KhoSanXuatNhapXuat&type=nhapkho&table=khosanxuat_khokv&cid=<?php echo $_smarty_tpl->tpl_vars['phongbanchuyen']->value;?>
"  />
            <?php }?>
...
?>
                    ...
                    <td align="center">
                        <?php if ($_smarty_tpl->tpl_vars['xuatkho']->value == 1) {?>
                            <?php $_smarty_tpl->_subTemplateRender("file:./allsearch/phongsxs.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
                        <?php } else { ?>
                            <?php $_smarty_tpl->_subTemplateRender("file:./allsearch/phongchuyens.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?> 
                        <?php }?>
                    </td>
                    <?php if ($_smarty_tpl->tpl_vars['xuatkho']->value != 1) {?>
...
?> 
                    ...
                    <td>
                        <?php $_smarty_tpl->_subTemplateRender("file:./allsearch/tlq10s.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?> 
                    </td>
                    <td>
                        <?php $_smarty_tpl->_subTemplateRender("file:./allsearch/tlq10gcs.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
                    </td>            
                    <td align="center">
                    	<?php $_smarty_tpl->_subTemplateRender("file:./allsearch/madhsxs.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
                    </td>
                    <td align="center">
...
">
                       ...
                       <td>
                            ...
                            <?php }?>     
                        <?php } else { ?>
                            <?php if ($_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['cidchuyen'] > 0) {?>
                                <?php echo $_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['typekhodau'];?>
                    ...
                    <?php }?>
                       ...
                       <td class="text-right">
                            <?php $_smarty_tpl->_assignInScope('tongluongQ10', round($_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['cannangv']*$_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['tuoivang'],3));?>
                            <?php echo $_smarty_tpl->tpl_vars['tongluongQ10']->value;?>

                       </td>
                       <td class="text-right">
                            <?php $_smarty_tpl->_assignInScope('tongluongQ10GiaCong', round($_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['cannangv']*0.77,3));?>
                            <?php echo $_smarty_tpl->tpl_vars['tongluongQ10GiaCong']->value;?>
                       ...
                       <?php $_smarty_tpl->_assignInScope('tongQ10', $_smarty_tpl->tpl_vars['tongQ10']->value+$_smarty_tpl->tpl_vars['tongluongQ10']->value);?>
                       <?php $_smarty_tpl->_assignInScope('tongQ10GiaCong', $_smarty_tpl->tpl_vars['tongQ10GiaCong']->value+$_smarty_tpl->tpl_vars['tongluongQ10GiaCong']->value);?>
                    </tr>  
                 <?php
}
}
?> 
                 <tr class="Paging fontSizeTon">
                    <td align="right" colspan="<?php echo $_smarty_tpl->tpl_vars['colspan']->value;?>
"> <strong class="colorXanh">Tổng/trang:</strong> </td>
                    ...
                    <td align="right"><span class="colorXanh"></span><?php echo $_smarty_tpl->tpl_vars['tongQ10']->value;?>
</td>
                    <td align="right"><span class="colorXanh"></span><?php echo $_smarty_tpl->tpl_vars['tongQ10GiaCong']->value;?>
</td>
                    <td align="right"><span class="colorXanh"></span></td>
                    <td align="right"><span class="colorXanh"></span></td>
                </tr>  
...
?> 
                    <tr class="Paging fontSizeTon">
                        <td align="right" colspan="<?php echo $_smarty_tpl->tpl_vars['colspan']->value;?>
">
                            <?php echo getName('loaivang','name_vn',$_smarty_tpl->tpl_vars['totalLoaivang']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_j']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_j']->value['index'] : null)]['idloaivang']);?>
                        ...
                        <td align="right"></td>
                        <td align="right"><?php echo $_smarty_tpl->tpl_vars['totalLoaivang']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_j']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_j']->value['index'] : null)]['tongluongq10'];?>
</td>
                        <td align="right"><?php echo $_smarty_tpl->tpl_vars['totalLoaivang']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_j']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_j']->value['index'] : null)]['tongluongq10giacong'];?>
</td>
                        <td align="right"></td>
                        <td align="right"></td>
                    </tr> 
...
?> 
                <tr class="Paging fontSizeTon">
                    <td align="right" colspan="<?php echo $_smarty_tpl->tpl_vars['colspan']->value;?>
"> <strong class="colorXanh">Tổng tất cả:</strong> </td>
