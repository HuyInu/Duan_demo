<?php
/* Smarty version 4.1.1, created on 2023-08-18 13:16:29
  from 'D:\wamp64\www\duan_demo\templates\tpl\Kho-A9-Thong-Ke\nhap-xuat-kho-kimcuong.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_64df0cbd438239_39632847',
  'has_nocache_code' => true,
  'file_dependency' => 
  array (
    '981cce3712915328b95f3c82bd661c4492f4bb38' => 
    array (
...
function content_64df0cbd438239_39632847 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="MainTable">
    		<table  class="table-bordered">
                <tr class="trheader">
                    ...
                    <td width="5%">
                        <strong>SL Nhập</strong>
                    </td>
                    <td width="8%">
                        <strong>Đơn Giá Nhập</strong>
                    </td>
                    <td width="5%">
                        <strong>SL Xuất</strong>
                    </td>
                    <td width="8%">
                        <strong>Đơn Giá Xuất</strong>
                    </td>
                </tr>
                <tr>
                    <td align="center"></td>
...
?> 
                   ...
                   <?php if ($_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['trangthai'] == 2) {?> <!--Xuất Kho-->
                   		<?php $_smarty_tpl->assign("checkKhoanTuNgayDenNgayXK" , insert_checkKhoanTuNgayDenNgayXuatKho (array('datedxuat' => $_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['dated'], 'fromdays' => $_smarty_tpl->tpl_vars['fromdayCheck']->value, 'todays' => $_smarty_tpl->tpl_vars['todaycheck']->value),$_smarty_tpl), true);?> 
                   <?php }?>
...
">
  ...
  <?php echo $_smarty_tpl->tpl_vars['checkKhoanTuNgayDenNgayXK']->value;?>
                       ...
                       <td class="text-right">
                       		<?php if ($_smarty_tpl->tpl_vars['checkKhoanTuNgayDenNgayNK']->value == 1) {?>
                                ...
                                <?php $_smarty_tpl->_assignInScope('tongslNhap', $_smarty_tpl->tpl_vars['tongslNhap']->value+1);?>
                                <?php $_smarty_tpl->_assignInScope('tongdongiaNhap', $_smarty_tpl->tpl_vars['tongdongiaNhap']->value+$_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['dongiaban']);?> 
                            <?php }?>
                       </td> 
                        <td class="text-right">
                       ...
                       <td class="text-right">
                       		<?php if ($_smarty_tpl->tpl_vars['checkKhoanTuNgayDenNgayXK']->value == 1) {?>
                                ...
                                <?php $_smarty_tpl->_assignInScope('tongslXuat', $_smarty_tpl->tpl_vars['tongslXuat']->value+1);?>
                       			<?php $_smarty_tpl->_assignInScope('tongdongiaXuat', $_smarty_tpl->tpl_vars['tongdongiaXuat']->value+$_smarty_tpl->tpl_vars['view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['dongiaban']);?> 
                            <?php }?>
                       </td> 
...
?> 
                 <tr class="Paging fontSizeTon">
                    ...
                    <td align="right"><span class="colorXanh"> <?php echo number_format($_smarty_tpl->tpl_vars['tongslNhap']->value,0,".",",");?>
 </span></td>
                    <td align="right"><span class="colorXanh"> <?php echo number_format($_smarty_tpl->tpl_vars['tongdongiaNhap']->value,3,".",",");?>
 </span></td>
                    
                    <td align="right"><span class="colorXanh"> <?php echo number_format($_smarty_tpl->tpl_vars['tongslXuat']->value,0,".",",");?>
 </span></td>
                    <td align="right"><span class="colorXanh"> <?php echo number_format($_smarty_tpl->tpl_vars['tongdongiaXuat']->value,3,".",",");?>
 </span></td>
                </tr> 
                
                <tr class="Paging fontSizeTon">
                    <td align="right" colspan="12"> <strong class="colorXanh">Tổng tất cả:</strong> </td>
                    <td align="right"><span class="colorXanh"> <?php echo $_smarty_tpl->tpl_vars['gettotalnhap']->value['tongsoluong'];?>
 </span></td>
                    <td align="right"><span class="colorXanh"> <?php echo $_smarty_tpl->tpl_vars['gettotalnhap']->value['tongdongia'];?>
 </span></td>
                    
                    <td align="right"><span class="colorXanh"> <?php echo $_smarty_tpl->tpl_vars['gettotalxuat']->value['tongsoluong'];?>
 </span></td>
                    <td align="right"><span class="colorXanh"> <?php echo $_smarty_tpl->tpl_vars['gettotalxuat']->value['tongdongia'];?>
 </span></td>
                </tr>                                
			</table>
    	</div>   
