    		...
    		<table  class="table-bordered">
                ...
                <!--{section name=i loop=$viewtest}--> 
                    <tr id="g<!--{$view[i].id}-->">
                       ...
                       <td>
                       		<!--{if $xuatkho eq 1}-->
                                <!--{$viewtest[i].datedxuat|date_format:"%d/%m/%Y"}-->
                            <!--{else}-->
                       ...
                       <td>
                       		<!--{insert name='getName' table='loaivang' names='name_vn' id=$viewtest[i].idloaivang}-->
                       </td> 
                       <td class="text-right">
                       		<!--{assign var="tcannangvh" value=$viewtest[i].cannangvh}-->
                       ...
                       <td class="text-right">
                        ...
                        <td class="text-right">
                        	<!--{assign var="tcannangv" value=$viewtest[i].cannangv}-->
                            <!--{$tcannangv|number_format:3:".":","}-->
                       </td>
                       <td>
                       		<!--{if $xuatkho eq 1}-->
                                <!--{if $viewtest[i].chonphongbanin gt 0}--> 
                                    <!--{insert name='getNamKhoSanXuat' id=$viewtest[i].chonphongbanin}--> 
                                <!--{/if}-->     
                            <!--{else}-->
                               <!--{if $viewtest[i].cidchuyen gt 0}-->
                       ...
                       <!--{assign var="tongCannangh" value=$tongCannangh+$viewtest[i].cannangh}-->
