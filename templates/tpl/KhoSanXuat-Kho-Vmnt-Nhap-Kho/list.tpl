                ...
                <!--{section name=i loop=$view}--> 
                    <tr id="g<!--{$view[i].id}-->">
                       		...
                       		<!--{if $view[i].typechuyen eq 1 }-->
                                <!--{if $view[i].type eq 1 }-->
                                    <!--{if $checkPer8 eq "true" }-->
                                        <a href="javascript:void(0)" onclick="xacnhanchuyenKhoSanXuat('xacnhanchuyenKhoSanXuat', <!--{$view[i].cid}-->, <!--{$view[i].id}-->, '<!--{$view[i].typekho}-->')" title="Xác Nhận"> 
                       ...
                       <td align="center">
                       		<!--{if $view[i].typechuyen eq 1 }-->
                                <!--{if $view[i].type eq 1 }-->
                                    <!--{if $checkPer9 eq "true" }-->
                                        <a href="javascript:void(0)" onclick="xacnhanchuyenKhoSanXuat('tralaichuyenKhoSanXuat', <!--{$view[i].cid}-->, <!--{$view[i].id}-->, '<!--{$view[i].typekho}-->')" title="Trả Lại"> 
