    		...
    		<table  class="table-bordered">
                ...
                <!--{section name=i loop=$view}--> 
                   ...
                   <!--{/if}-->
                    <tr id="g<!--{$view[i].id}-->">
                        <td>
                            <!--{$smarty.section.i.index+1+$number}-->  <!--{$checkKhoanTuNgayDenNgayXK}-->
                       </td>
                       <td>
                       ...
                       <td class="text-right">
                       		<!--{if $checkKhoanTuNgayDenNgayNK eq 1}-->
                                ...
                                <!--{assign var="tongslNhap" value=$tongslNhap+1}-->
                                <!--{assign var="tongdongiaNhap" value=$tongdongiaNhap+$view[i].dongiaban}--> 
                            <!--{/if}-->
                       </td> 
                        <td class="text-right">
                       ...
                       <td class="text-right">
                       		<!--{if $checkKhoanTuNgayDenNgayXK eq 1}-->
                                ...
                                <!--{assign var="tongslXuat" value=$tongslXuat+1}-->
                       			<!--{assign var="tongdongiaXuat" value=$tongdongiaXuat+$view[i].dongiaban}--> 
                            <!--{/if}-->
                       </td> 
                 ...
                 <tr class="Paging fontSizeTon">
                    ...
                    <td align="right"><span class="colorXanh"> <!--{$tongslNhap|number_format:0:".":","}--> </span></td>
                    <td align="right"><span class="colorXanh"> <!--{$tongdongiaNhap|number_format:3:".":","}--> </span></td>
                    
                    <td align="right"><span class="colorXanh"> <!--{$tongslXuat|number_format:0:".":","}--> </span></td>
                    <td align="right"><span class="colorXanh"> <!--{$tongdongiaXuat|number_format:3:".":","}--> </span></td>
                </tr> 
                
                <tr class="Paging fontSizeTon">
                    <td align="right" colspan="12"> <strong class="colorXanh">Tổng tất cả:</strong> </td>
                    <td align="right"><span class="colorXanh"> <!--{$gettotalnhap.tongsoluong}--> </span></td>
                    <td align="right"><span class="colorXanh"> <!--{$gettotalnhap.tongdongia}--> </span></td>
                    
                    <td align="right"><span class="colorXanh"> <!--{$gettotalxuat.tongsoluong}--> </span></td>
                    <td align="right"><span class="colorXanh"> <!--{$gettotalxuat.tongdongia}--> </span></td>
                </tr>                                
			</table>
    	</div>   
    </form> 
