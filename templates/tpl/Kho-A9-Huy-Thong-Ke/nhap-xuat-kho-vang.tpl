...
<div class="MainContent">
	<form name="f" id="f" method="post" onsubmit="return KhoNguonVaoThongKeNhapXuatVang('<!--{$path_url}-->/sources/Kho-A9-Huy-Thong-Ke.php?act=<!--{$smarty.request.act}-->&cid=<!--{$smarty.request.cid}-->')"> 
    		...
    		<table  class="table-bordered">
                ...
                <!--{section name=i loop=$view}-->
                    ...
                    <!--{if $view[i].trangthai eq 2}--> <!--Xuất Kho-->  
                		<!--{insert name='checkKhoanTuNgayDenNgayXuatKho' datedxuat = $view[i].datedxuat fromdays = $fromdayCheck todays = $todaycheck assign="checkKhoanTuNgayDenNgayXK"}--> 
                    <!--{/if}-->
                    <tr id="g<!--{$view[i].id}-->">
                        <td>
