    		...
    		<table  class="table-bordered">
                ...
                <!--{section name=i loop=$view}--> 
                    <tr id="g<!--{$view[i].id}-->">
                       ...
                       <td>
                       		<!--{if $checkPer2 eq "true" }-->
                           	 <input type="text" id='showdu<!--{$view[i].id}-->' autocomplete="off" class="txtdatagirld text-right autoNumeric" value="<!--{$view[i].du}-->" onchange="updatedong('updatedong',this.value,<!--{$view[i].id}-->,'du','khonguonvao_khoachinct')"/>
                            <!--{else}-->
                            	<!--{$view[i].du}-->
                            <!--{/if}-->
                       </td> 
