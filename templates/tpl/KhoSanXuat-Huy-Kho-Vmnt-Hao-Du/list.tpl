...
<div class="goAction">
	<ul>
    	<li>
                <a href="javascript:void(0)" title="Thêm" onclick="return ChangeAdd('<!--{$path_url}-->/sources/KhoSanXuat-Huy-Kho-Vmnt-Hao-Du.php?act=add&cid=<!--{$smarty.request.cid}-->');">
                    <img src="<!--{$path_url}-->/images/add.png">
                </a> 
               	<a href="javascript:void(0)" title="Delete" onclick="ChangeAction('<!--{$path_url}-->/sources/KhoSanXuat-Huy-Kho-Vmnt-Hao-Du.php?act=dellist&cid=<!--{$smarty.request.cid}-->');">
...
<div class="MainContent">
	<form name="f" id="f" method="post" onsubmit="return searchKhoSanXuatHaoDu('<!--{$path_url}-->/sources/KhoSanXuat-Huy-Kho-Vmnt-Hao-Du.php?cid=<!--{$smarty.request.cid}-->')"> 
