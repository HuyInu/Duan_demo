	...
	<ul>
    	<li>
            <!--{if $checkPer1 eq "true" }-->
                <a href="javascript:void(0)" title="Thêm" onclick="return ChangeAdd('<!--{$path_url}-->/sources/KhoSanXuat-Kho-Vmnt-Xuat-Kho.php?act=add&cid=<!--{$smarty.request.cid}-->');">
            ...
            <!--{if $checkPer3 eq "true" }-->
               	<a href="javascript:void(0)" title="Delete" onclick="ChangeAction('<!--{$path_url}-->/sources/KhoSanXuat-Kho-Vmnt-Xuat-Kho.php?act=dellist&cid=<!--{$smarty.request.cid}-->');">
                    ...
                    <tr id="g<!--{$view[i].id}-->">
                       ...
                       <td align="center">
                       		<!--{if $checkPer6 eq "true" }-->
                                <select class="selectOption" id="chuyenkho<!--{$view[i].id}-->" onchange="chuyenKhoSanXuat('chuyenkhosanxuat', this.value, '<!--{$view[i].id}-->','<!--{$phongbanchuyen}-->','khosanxuat_vmnt')">
