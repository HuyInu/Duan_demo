...
if(!empty($fromDate)){
	...
	$whdatexuat.=' and datedxuat >= "'.$fromDate.'" ';
}
if(!empty($toDate)){
	...
	$whdatexuat.=' and datedxuat <= "'.$toDate.'" ';
}
if(!empty($daychungtus)){
	...
	$whdatexuat.=' and dated = "'.$daychungtus.'" ';
}
if(!empty($codes)){
	...
	$whdatexuat.=' and maphieu like "%'.$codes.'%" ';
}
...
if(!empty($idloaivang)){
	...
	$whdatexuat.=' and idloaivang =  '.$idloaivang.' ';
}
if(!empty($tongtlvangsauchetacs)){
	...
	$whdatexuat.=' and trongluongvangsauchetac like "%'.$tongtlvangsauchetacs.'%" ';
}
...
if(!empty($tuoivangsauchetacs)){
	...
	$whdatexuat.=' and tuoivangsauchetac like "%'.$tuoivangsauchetacs.'%" ';
}
if(!empty($hoichetacs)){
	...
	$whdatexuat.=' and hoiche like "%'.$hoichetacs.'%" ';
}
if(!empty($ghichus)){
	...
	$whdatexuat.=' and ghichu  like "%'.$ghichus.'%" ';
}
?>